...
@section('content')
    ...
    <div class="container-fluid">
        <form id="createPlanForm" method="POST" enctype="multipart/form-data" action="{{ route('plans.update', ['plan'=>$plan]) }}">
        @method('PUT')
        @csrf
        <div class="row martop30">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-6 text-left">
                        <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $plan->title }}" required autofocus>
                ...
                <div class="row martop30">
                    ...
                    <div class="col-md-6 text-left">
                        <input id="start_at" type="text" class="form-control{{ $errors->has('start_at') ? ' is-invalid' : '' }}" name="start_at" value="{{ $plan->start_at }}" required autofocus>
                ...
                <div class="row martop30">
                    ...
                    <div class="col-md-6 text-left">
                        <input id="end_at" type="text" class="form-control{{ $errors->has('end_at') ? ' is-invalid' : '' }}" name="end_at" value="{{ $plan->end_at }}" required autofocus>
                ...
                <div class="row martop30">
                    ...
                    <div class="col-md-6 text-left">
                        <input id="member" type="number" class="form-control{{ $errors->has('member') ? ' is-invalid' : '' }}" min="0" name="member" value="{{ $plan->member }}" required autofocus>
                ...
                <div class="row martop30">
                    ...
                    <div class="col-md-6 text-left">
                        <textarea id="description" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }} fix-textarea" name="description" value="{{ old('description') }}" required autofocus>{{$plan->description}}</textarea>
            ...
            <div class="col-md-5">
                <div id="imgCover" style="background-image: url('{{asset('/images/plans/'.$plan->cover)}}');" class="img-thumbnail custom_cover" alt="Cover">
...
@section('myjsfile')
    ...
    <script src="{{asset('js/plans/edit/add_marker_for_edit_function.js')}}"></script>
    ...
    <script src="{{asset('js/plans/edit/edit.js')}}"></script>
